      ...
      <div className="section" style={{ padding: '0 16px', marginBottom: '16px' }}>
        ...
        <div className="stats-grid">
          <div className="stat-card">
            <div className="stat-val">{stats?.flashcards_dominadas ?? '—'}</div>
            <div className="stat-lbl">FC dominadas</div>
          </div>
          <div className="stat-card">
            <div className="stat-val">{stats?.cuestionarios_completados ?? '—'}</div>
            <div className="stat-lbl">Cuestionarios</div>
          </div>
          <div className="stat-card">
          ...
          <div className="stat-card">
            <div className="stat-val">{stats?.materias_activas ?? '—'}</div>
            <div className="stat-lbl">Materias activas</div>
          </div>
        </div>
      </div>
